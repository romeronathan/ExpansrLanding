...
const Testimonial: React.FC = () => {
    return (
        <div className="drop-shadow-md bg-white py-6 sm:py-8 lg:py-12">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-y-10 sm:gap-y-12 lg:divide-x">
                    ...
                    <div className="flex flex-col items-center gap-4 md:gap-6 sm:px-4 lg:px-8">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-2 md:gap-3">
                            ...
                            <div>
                                <div className="text-indigo-500 text-sm md:text-base font-bold text-center sm:text-left">Big Johnny</div>
                                <p className="text-gray-500 text-sm md:text-sm text-center sm:text-left">CEO / Auto</p>
                            </div>
                        </div>
                    </div>
